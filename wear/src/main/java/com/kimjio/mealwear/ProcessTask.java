...
public abstract class ProcessTask extends AsyncTask<Integer, Integer, Long> {
    ...
    protected Long doInBackground(Integer... params) {
        ...
        //String mContry = mPref.getString("mContry", "");
        //String mSchoolCode = mPref.getString("mSchoolCode", "");
        //String mSchoolCode1= mPref.getString("mSchoolCode1", "");
        //String mSchoolCode2 = mPref.getString("mSchoolCode2", "");
        ...
        /*final String CountryCode = mContry; // 접속 할 교육청 도메인
        final String schulCode = mSchoolCode; // 학교 고유 코드
        final String schulCrseScCode = mSchoolCode1; // 학교 종류 코드 1
        final String schulKndScCode = mSchoolCode2; // 학교 종류 코드 2 */
